...
import { Clock, CheckCircle2, XCircle, ArrowDownLeft } from "lucide-react";
        ...
        <div className="rounded-[2rem] border border-slate-200 dark:border-neutral-800 bg-white dark:bg-neutral-900/50 backdrop-blur-sm p-8 h-full shadow-sm">
            ...
            <div className="space-y-4">
                {onRampTransactions.slice(0, 5).map((t) => (
                    <div
                        key={t.id}
                        className="flex items-center justify-between group p-2 -mx-2 rounded-xl hover:bg-slate-50 dark:hover:bg-neutral-800/50 transition-colors"
                    >
                        ...
                        <div className="text-right">
                            ...
                            <div
                                className={`text-[10px] font-bold uppercase tracking-wider ${t.status === "Success"
