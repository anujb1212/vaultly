...
function formatINRPartsFromPaise(paise: number) {
    ...
    const fraction = Math.abs(safe % 100);
    return {
        rupeesText: rupees.toLocaleString("en-IN"),
        fractionText: String(fraction).padStart(2, "0"),
    };
}
                                    ...
                                    <div className="relative z-10 flex flex-col md:flex-row md:items-end md:justify-between gap-8">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            {balanceLoading ? (
                                                ...
                                                <div className="flex items-baseline text-white whitespace-nowrap">
                                                    <span className="text-6xl md:text-7xl font-bold tracking-tight truncate">
                                                        ₹{rupeesText}
                                                    </span>
                                                    <span className="text-3xl text-slate-400 font-light ml-1 tabular-nums opacity-80">
                                                        .{fractionText}
                                                    </span>
                                                </div>
                                            )}
                                        ...
                                        <div className="shrink-0 w-full md:w-auto flex gap-4">
                                            <button
                                                ...
                                                className="flex-1 md:flex-none h-14 px-8 rounded-2xl bg-white text-slate-900 font-bold text-sm hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-xl shadow-white/5 whitespace-nowrap"
                                            >
                                                <Plus className="w-5 h-5" /> Add Money
                                            </button>
                                            <button
                                                onClick={() => router.push("/p2ptransfer")}
                                                className="flex-1 md:flex-none h-14 px-8 rounded-2xl bg-indigo-600 text-white font-bold text-sm hover:bg-indigo-500 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-xl shadow-indigo-500/20 whitespace-nowrap"
                                            >
                        ...
                        <div className="bg-white dark:bg-neutral-900 rounded-[2.5rem] p-8 border border-slate-200 dark:border-neutral-800 shadow-sm">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    <div className="flex justify-between text-sm mb-2">
                                        <span className="text-slate-500 dark:text-neutral-400 flex items-center gap-2 font-medium">
                                            <div className="p-1 bg-rose-100 dark:bg-rose-900/30 rounded-md">
                                    ...
                                    <div className="h-2.5 w-full bg-slate-100 dark:bg-neutral-800 rounded-full overflow-hidden">
                                        <div className="h-full bg-rose-500 rounded-full w-[30%] shadow-lg shadow-rose-500/30" />
                                    </div>
                                </div>
                            </div>
                        </div>
